  ...
  return (
    <div>
      <div class="container mx-auto">
        <div class="relative top-10 lg:w-1/2 mx-auto rounded-lg bg-blue-800 px-8 py-6 text-white">
          <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold">Subscribe to our news</h2>
            <div class="flex">
              <input
                type="email"
                placeholder="email"
                class="rounded-l-lg bg-white px-4 py-2"
              />
              <button class="rounded-r-lg bg-white px-4 py-2 text-blue-800">
                Subscribe
              </button>
            </div>
          </div>
      ...
      <footer class="bg-[#1e293b] px-8 py-8 text-white pt-16">
        <div class="container mx-auto flex items-start justify-between">
          <h1 class="text-5xl font-bold">Footer</h1>
          <div class="flex space-x-4">
            <a href="#" class="rounded-full bg-[#3b5998] p-2 text-white">
              <i class="fab fa-facebook-f px-1.5 text-lg"></i>
            </a>
            <a href="#" class="rounded-full bg-[#00acee] p-2 text-white">
              <i class="fab fa-twitter px-1 text-lg"></i>
            </a>
            <a href="#" class="rounded-full bg-[#C13584] p-2 text-white">
              <i class="fab fa-instagram px-1 text-lg"></i>
            </a>
            <a href="#" class="rounded-full bg-[#0A66C2] p-2 text-white">
              <i class="fab fa-linkedin-in px-1 text-lg"></i>
            </a>
          </div>
        </div>
        <div class="container mx-auto mt-8 grid grid-cols-4 gap-4">
          <div>
            <h2 class="mb-2 text-xl font-semibold">Resources</h2>
            <ul class="list-none">
              <li>Resource 1</li>
              <li>Resource 2</li>
              <li>Resource 3</li>
          ...
          <div>
            <h2 class="mb-2 text-xl font-semibold">Company</h2>
            <ul class="list-none">
              <li>About Us</li>
              <li>Our Team</li>
              <li>Contact</li>
          ...
          <div>
            <h2 class="mb-2 text-xl font-semibold">Social</h2>
            <ul class="list-none">
              <li>Social 1</li>
              <li>Social 2</li>
              <li>Social 3</li>
